...
Theorem while_TimeOut_lemma:
  evaluate (While e (prog:'a prog),s) = (SOME TimeOut,t) ∧
  good_dimindex (:α) ⇒
  ∃k. evaluate (While e prog, s with clock := s.clock + k) = (r, t') ∧
      r ≠ SOME TimeOut
Proof
  Induct_on ‘s.clock’>>rw[Once evaluate_def,AllCaseEqs()]>>
